...
<section class="row-3 pt-5 pb-5 ">
  <h1 class="text-center custom-control"><u class="pt-2">قد ي</u>همك أيضاً </h1>
...
<section class="row-3 pt-5 pb-5 serverHome">
  <h1 class="text-center custom-control"><u class="pt-2 ">خدم</u>ات بالعدل </h1>
...
<section class="row-4 pt-5 pb-5">
  <h1 class="text-center custom-control"><u class="pt-2">خطة</u> الدفع </h1>
...
<section class="row-4 pt-5 pb-5 " >
  <h1 class="text-center custom-control"><u class="pt-2">أحدث</u>  المقالات </h1>
  <div class="row mr-5 ml-5 pt-5" >
    <div class="col-sm-4" >    
      <img  class='' src="<?=base_url('assets/website/arabic/');?>img/civilmatters.svg" />
    </div>
    <div class="col-sm-4" >    
      <img  class='' src="<?=base_url('assets/website/arabic/');?>img/civilmatters.svg" />
    </div>
