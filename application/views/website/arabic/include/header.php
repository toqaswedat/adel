...
<nav class="navbar navbar-expand-lg navbar-light bg-dark text-light pr-5">
  ...
  <div class="collapse navbar-collapse justify-content-between" id="navbarSupportedContent">
    ...
    <ul class="collapse navbar-collapse col-4 d-flex justify-content-around" >
      <li class="right col-2">
        <a class="text-light" href="<?=base_url('#');?>"><i class="fa fa-search icon-style"></i></a>
      </li>
      <li class="border border-white col-1">
        <a href="<?=base_url('');?>" class="text-light font-weight-light">EN</a>
      </li>
      <li class="col-3">
        <a class=" text-light" href="<?=base_url();?>arabic/Login/member_normal_login/">تسجيل الدخول</a>
      </li>
      <li class="col-4">
        <button type="button" class="navbar-toggle bg-warning font-weight-bold datepicker w-100 my-sm-n3" data-toggle="collapse" data-target="#navbar">
         حساب جديد
        </button>
      </li>
    </ul>
